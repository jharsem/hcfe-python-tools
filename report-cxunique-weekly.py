...
def buildCSV(fr,to,title,data):
    ...
    with open(filename, "w", newline='') as csv_file:
        ...
        csv_writer.writerow(['Branch','Unique Cx FY20']) # write headers
        for branch in data:
...
dt_to = today
#dt_from = datetime.datetime(2020,4,1)
#dt_to =  datetime.datetime(2020,4,5)
...
WHERE i.SALE_DATE BETWEEN '2020-07-01 00:00:00' AND '{}'""".format(str_dt_from)
...
descr = """
    ...
    Report Notes
        ...
        Unique Cx In Year: Counts of unique members with accounts created this Financial Year.
    
    """
subject = "HCFE Weekly Unique Cx In FY Report (Weekly) for {} to {}"
